...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (data.size()<0){
            ...
            if (msg.getType())
                holder.img.setImageResource(res.getIdentifier("com.example.assignment3:drawable/icons8-circled-user-male-skin-type-6-16.png", null, null));
            else
                holder.img.setImageResource(res.getIdentifier("com.example.assignment3:drawable/icons8-circled-user-female-skin-type-6-16.png", null, null));
        }
        return vi;
    }
