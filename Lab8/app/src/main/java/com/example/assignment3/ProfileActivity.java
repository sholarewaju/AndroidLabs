...
public class ProfileActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE = 419;
    ImageButton
            captureButton;
    Button goToChatButton,gotoweatherforecastBtn,gototoolbarpageBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gototoolbarpageBtn=findViewById(R.id.gototoolbarpage);
        ...
        gototoolbarpageBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                //what happens
                openToolbarActivity();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQUEST_CODE ){
            Toast.makeText(this, "somethings", Toast.LENGTH_SHORT).show();
            finish();
        }
